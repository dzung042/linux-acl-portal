...
SMB / Samba shared storage permissions
Private cloud VPS management
...
Audit logging (ACL change history)
Multi-server sync
Role-based templates (Dev / QA / Prod)
SMB/Samba auto provisioning
API mode for CI/CD integration
⭐ Why this project?

Most tools manage permissions at the application level.

This project manages real Linux permissions directly, making it ideal for:
